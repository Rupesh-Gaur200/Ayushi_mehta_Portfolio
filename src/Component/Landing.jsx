        ...
        <div className="px-20 py-28">
         ...
         <div className="flex gap-2">
           ...
           <div className="flex flex-col gap-20">
            ...
            Hi ! I'm Yashi Gupta, An Engineer And A Developer. I'am pursuing B.Tech Computer Science and Engineering  from Lovely Professional University , doing my minors in Web Development and Android Development .I am a web development freelancer and like to explore different niches over time. Having experience in website development, event management and research and development.
            </p>
            <p className="text-wrap font-semibold text-xl italic text-[#444444]">
          ...
          <img className="h-[580px]" src="https://yashi-gupta.netlify.app/static/media/redTheme-girl.e2b9dd83.svg"></img>
